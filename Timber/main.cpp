...
int main()
{
	...
	// Make a tree sprite
	Texture textureTree;
	textureTree.loadFromFile("data/tree.png");
	Sprite spriteTree;
	...
	// Prepare the bee
	Texture textureBee;
	textureBee.loadFromFile("data/bee.png");
	Sprite spriteBee;
	...
	Font font;
	font.loadFromFile("data/KOMIKAP_.ttf");
	...
	Texture textureLog;
	if (!textureLog.loadFromFile("data/log.png"))
	{
		assert(false);
	}
	Sprite spriteLog;
	...
	if (!chopBuffer.loadFromFile("data/woodchop.wav")) 
	{
		// Handle error, print message, or assert
		std::printf("Error: Failed to load woodchop.wav");
		assert(false);
	}
	Sound chop;
	...
	if (!deathBuffer.loadFromFile("data/plank.wav"))
	{
		// Handle error, print message, or assert
		std::printf("Error: Failed to load plank.wav");
		assert(false);
	}
	Sound death;
	...
	if (!ootBuffer.loadFromFile("data/out_of_time.wav"))
	{
		// Handle error, print message, or assert
		std::printf("Error: Failed to load out_of_time.wav");
		assert(false);
	}
	Sound outOfTime;
